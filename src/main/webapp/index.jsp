...
<body>
	...
	<main class="container-fluid">
		...
		<a href="displayByBikeNo.jsp">Get bike details by bike no.</a><br /> <a
			href="listActiveBikes.html">Get list of available bikes</a><br /> <a
			href="netAsset.jsp">Get current Asset</a>
